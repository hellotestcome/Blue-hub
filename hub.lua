    ...
    while task.wait(0.5) do
        for _, v in pairs(CoreGui:GetDescendants()) do
            if v:IsA("Frame") and v.Size.X.Offset > 100 then
                ...
                if not v:FindFirstChild("QuangCorner") then
            ...
            elseif v:IsA("ImageLabel") or (v:IsA("TextLabel") and (v.Text:find("Redz") or v.Text:find("Hub"))) then
                v.Visible = false
            end
        end
    end
...
v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://114326813674703", BackgroundTransparency = 0 },
    Size = UDim2.new(0, 35, 0, 35),
    Corner = { CornerRadius = UDim.new(0.25, 0) },
})

local v484 = v466:MakeTab({"Discord", "info"})
local v485 = v466:MakeTab({"Xem sex", "home"})
local v487 = v466:MakeTab({"Quest | Items", "swords"})
local v486 = v466:MakeTab({"Auto Fishing", "rbxassetid://114326813674703"})
...
v484:AddDiscordInvite({
    Name = " QUANG LITE",
    Description = "nhìn cc",
    Logo = "rbxassetid://114326813674703",
